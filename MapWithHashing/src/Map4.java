...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public final void add(K key, V value) {
        ...
        int modIndex = mod(hash, this.hashTable.length);
        this.hashTable[modIndex].add(key, value);
    ...
    public final Pair<K, V> remove(K key) {
        ...
        int hash = key.hashCode();
        int modIndex = mod(hash, this.hashTable.length);
        Map.Pair<K, V> r = this.hashTable[modIndex].remove(key);
        this.size--;
    ...
    public final Pair<K, V> removeAny() {
        ...
        Map.Pair<K, V> removed = this.hashTable[0].removeAny();
        this.size--;
        return removed;
    ...
    public final V value(K key) {
        ...
        int hash = key.hashCode();
        int modlocation = mod(hash, this.hashTable.length);
        return this.hashTable[modlocation].value(key);
    }
    ...
    public final boolean hasKey(K key) {
        ...
        int modloc = mod(key.hashCode(), this.hashTable.length);

        return this.hashTable[modloc].hasKey(key);
